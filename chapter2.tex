...
Lexicon-based methods like VADER assign scores to individual words and then combine those scores to get an overall sentiment. This is a well-known approach for early systems. These were designed specifically for social media text and handled punctuation, capitalization, and emoticons as signals of sentiment intensity.
