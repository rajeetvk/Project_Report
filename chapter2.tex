...
Several BERT-based systems have been published on GoEmotions. Most report accuracy in the
range of 0.46 to 0.58 on the full 28-class problem. On the simplified 3-class version (Positive,
Negative, Neutral), results are higher but still reflect the difficulty of the dataset. None of
...
spaces and found that the topology changes depending on the semantic content of the text.
