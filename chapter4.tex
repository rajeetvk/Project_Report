...
topological features and reduce reliability. Alternative approaches like Simplicial
SMOTE~\cite{simplicial_smote} or TS-SMOTE~\cite{ts_smote} attempt to preserve local structure
during oversampling, but for this work, preserving the original embedding geometry was deemed
paramount.
...
XGBoost is chosen because it has shown strong performance in multi-class emotion
classification tasks~\cite{xgboost_eeg}. Specifically:
\begin{itemize}
