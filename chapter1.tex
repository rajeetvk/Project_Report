...
as sarcasm~\cite{sarcasm}, leading to misleading results. Standard models treat all
...
\begin{itemize}
    ...
    \item \textbf{Chapter 5: Implementation Details} provides an in-depth explanation of the technical implementation, including embedding strategies and topological feature extraction.
