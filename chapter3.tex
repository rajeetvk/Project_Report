...
Table~\ref{tab:techstack} lists the key technologies used to build the system.
...
Table~\ref{tab:req_summary} summarizes the key requirements of the system.
...
As shown in Table~\ref{tab:req_summary}, high priority is given to the core classification and
